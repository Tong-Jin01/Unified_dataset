...
def parse_arguments(is_training: bool = True):
    ...
    parser.add_argument("--alpha", type=int, default=60, help="_")
    parser.add_argument("--N", type=int, default=3, help="_")
    parser.add_argument("--L", type=int, default=2, help="_")
    parser.add_argument("--groups_num", type=int, default=18, help="_")
    parser.add_argument("--min_images_per_class", type=int, default=4, help="_")
    # Model parameters
    ...
    if is_training:
        ...
        print(len(os.listdir(args.train_set_folder)))
