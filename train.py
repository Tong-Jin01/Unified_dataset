...
total1 = sum([param.nelement() for param in model.backbone.parameters()])
print("Number of model backbone parameter: %.2fM" % (total1/1e6))

total2 = sum([param.nelement() for param in model.aggregation.parameters()])
print("Number of model aggregation parameter: %.2fM" % (total2/1e6))

totalpara = 0
for param in model.parameters():
    if param.requires_grad == True:
        totalpara += param.nelement()
print("Number of tunable parameter: %.2fM" % (totalpara/1e6))
